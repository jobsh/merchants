 ...
 */
@Service
public class ContractOperLogServiceImpl implements IContractLogService
{
    @Autowired
    private ContractOperLogMapper contractOperLogMapper;
    ...
    {
        return contractOperLogMapper.deleteOperLogByIds(operIds);
    }
    ...
    {
        contractOperLogMapper.cleanOperLog();
    }
}
